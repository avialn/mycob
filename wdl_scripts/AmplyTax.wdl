...
workflow AmplyTax {
    ...
    input {
        File fastq_1 = "/home/admin/08.10.2023/16Sv3v4-1_S1_L001_R1_001.fastq.gz"
        File fastq_2 = "/home/admin/08.10.2023/16Sv3v4-1_S1_L001_R2_001.fastq.gz"
        String sample_name = "16Sv3v4-1_S1"
        ...
        File index_genome = "/home/admin/cromwell_all/db/human_bowtie2_index/GRCh38_ERCC.bowtie2.tar"
        File index_transcriptome = "/home/admin/cromwell_all/db/human_bowtie2_index/GRCh38_transcriptome.bowtie2.tar"

        #kraken/bracken classifiers
        File kraken2_ncbi = "/home/admin/cromwell_16s/classifiers/kraken2/ncbi_16s_18s_28s_ITS_kraken2.tar.gz" # default
        File kraken2_standard_8gb = "/home/admin/cromwell_16s/classifiers/kraken2/k2_standard_08gb_20230605.tar.gz"
        File kraken2_pluspf_8gb = "/home/admin/cromwell_16s/classifiers/kraken2/k2_pluspf_08gb_20231009.tar.gz"
        File kraken2_16s = "/home/admin/cromwell_16s/classifiers/kraken2/16S_Greengenes13.5_20200326.tar.gz "

        Boolean microb_16s = true
        #microb_16s dada2 classifiers
        File silva_138 = "/home/admin/cromwell_16s/classifiers/dada2/silva_nr99_v138.1_wSpecies_train_set.fa.gz" #default
        File sbdi_gtdb = "/home/admin/cromwell_16s/classifiers/dada2/36980767"
        File rdp = "/home/admin/cromwell_16s/classifiers/dada2/rdp_train_set_18.fa.gz"

        Boolean fungi_its = false
        #fungi_ITS dada2 classifiers
        File unite_fungi = "/home/admin/cromwell_16s/classifiers/dada2/sh_general_release_dynamic_18.07.2023.fasta"   #default
        File unite_all = "/home/admin/cromwell_16s/classifiers/dada2/sh_general_release_dynamic_all_18.07.2023.fasta"

        Boolean fungi_18s = false
        #fungi_18s dada2 classifiers
        File silva_132 = "/home/admin/cromwell_16s/classifiers/dada2/silva_132.18s.99_rep_set.dada2.fa.gz" #default
        File pr2= "/home/admin/cromwell_16s/classifiers/dada2/pr2_version_5.0.0_SSU_dada2.fasta.gz"
