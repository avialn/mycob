...
workflow processing {
    ...
    input {
        ...
        File reference_fasta_entero = " /home/cromwell/mycob-ref/gut/refseq/entero.fasta"
        File reference_fasta_astrovirus = "/home/cromwell/mycob-ref/gut/refseq/astrovirus.fasta"
        File reference_fasta_kobuvirus = "/home/cromwell/mycob-ref/gut/refseq/kobuvirus.fasta"
        File reference_fasta_mastadeno = "/home/cromwell/mycob-ref/gut/refseq/mastadeno.fasta"
        File reference_fasta_norovirus = "/home/cromwell/mycob-ref/gut/refseq/norovirus.fasta"
        File reference_fasta_parechovirus = "/home/cromwell/mycob-ref/gut/refseq/parechovirus.fasta"
        File reference_fasta_picobina = "/home/cromwell/mycob-ref/gut/refseq/picobina.fasta"
        File reference_fasta_rosavirus = "/home/cromwell/mycob-ref/gut/refseq/rosavirus.fasta"
        File reference_fasta_rotavirus = "/home/cromwell/mycob-ref/gut/refseq/rotavirus.fasta"
        File reference_fasta_salivirus = "/home/cromwell/mycob-ref/gut/refseq/salivirus.fasta"
        File reference_fasta_sapovirus = "/home/cromwell/mycob-ref/gut/refseq/sapovirus.fasta"
        File reference_fasta_torovirus = "/home/cromwell/mycob-ref/gut/refseq/torovirus.fasta"
        File reference_fasta_cosavirus = "/home/cromwell/mycob-ref/gut/refseq/cosavirus.fasta"

        File rotavirus_metadata = "/home/cromwell/mycob-ref/gut/rotavirus_metadata.csv"
    ...
    if (irma_entero.proceed == "yes") {
        ...
        call irma.Blast as blast_entero {
            ...
            db = "EnteroDB",
            threads = threads,
            docker = "cr.yandex/crpl2lv1lkr7g21e6q8g/blast:2.15.0gut"
        }
    ...
    output {
        ...
        String? both_surviving_cut_str = cutadapt_kraken.both_surviving_cut
